...
begin 
    ...
    where date(favorito.fecha) between fechaInicio and fechaFin and usuarioID = favorito.usuario_id;
...
delimiter ;
drop event borrarPublicacionVieja;
-- f 
delimiter //
